...
void Character::SaveToDB(bool create)
{
    if (create)
    {
        Database::Char()->PQuery(INSERT_CHARACTER, GetGuid(), GetSession()->GetAccountInfos().id, m_name.toLatin1().data(), m_race, m_gender, m_gfxId, m_color1, m_color2, m_color3, GetMapId(), GetCellId());
